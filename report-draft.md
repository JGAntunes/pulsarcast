...
(TODO use Baran figure do illustrate the differences)
...
Finally we have hybrid approaches to both of these extremes, were we rely on a distributed network of servers making the network topology resemble more of decentralised network as showed in figure (TODO figure number). This is the approach followed by systems like Gryphon, Jedi and Siena, which rely on a network of broker nodes to perform the work of persisting and distributing the events in a reliable fashion.
...
(TODO example image with the distinction between physical network and overlay network)
...
(TODO example figure of a Chord ring)
