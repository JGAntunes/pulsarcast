...
\texttt{Qm000000002CPGAzmfdYPghgrFtYFB6pf1BqMvqfiPDam8u} we could
address it using a UNIX path approach such as
\texttt{/Qm000000002CPGAzmfdYPghgrFtYFB6pf1BqMvqfiPDam8}. However we
could access its properties directly such as
\texttt{/Qm000000002CPGAzmfdYPghgrFtYFB6pf1BqMvqfiPDam8/\#} to get the
sub-topics list, or
\texttt{/Qm000000002CPGAzmfdYPghgrFtYFB6pf1BqMvqfiPDam8/parent} to get
...
descriptors for this topic. The key \texttt{\#} on the other hand
...
example \texttt{/sports}. If we are speaking about sub-topics though,
...
\texttt{/sports}, it cannot have a sub-topic \texttt{/fruits}, or
\texttt{/fruits/apples}. \texttt{/sports/football} however is a valid
example.
...
special key \texttt{\#} of the topic descriptor.
