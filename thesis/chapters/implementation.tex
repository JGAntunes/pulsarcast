...
This whole setup has been coded so that we can run it an automated
fashion, being able to bootstrap the Kubernetes cluster, deploy the Elastic
Stack and deploy any amount of IPFS Testbed nodes. As usual, the logic for this
is open source and accessible to anyone~\footnote{https://github.com/JGAntunes/ipfs-testbed}

\subsection{Usage}\label{testbed-architecture}
