...
hash~\footnote{https://tools.ietf.org/html/rfc3174} of its IP address). The
...
\begin{sidewaystable}
  \center
    ...
    Bayeux & Topic based & Decentralised & Tapestry \acrshort{dht} & Rendezvous node & Multicast tree & No & Yes & Best effort, no subscription persistence \\\hline
    Scribe & Topic based & Decentralised & Pastry \acrshort{dht} & Rendezvous node & Multicast tree & No & Yes & Best effort, no subscription persistence \\\hline
    Medhdoot & Content based & Decentralised & CAN \acrshort{dht} & Points in CAN \acrshort{dht} & CAN routing  & No & Yes & replicated subscriptions \\\hline
    Hermes & Type based & Decentralised & Pastry \acrshort{dht} & Rendezvous node & Multicast tree & No & Yes & Best effort \\\hline
    ...
    Mercury & Content based & Decentralised & Ring based \acrshort{dht}s & Overlay per attribute in schema & Route through ring overlays & No & Yes & Best effort \\\hline
    Sub-2-Sub & Content based & Decentralised & Ring based \acrshort{dht} and gossip based overlay & Clustering of similar subscriptions & Gossip and ring overlay routing & No & No & Best effort \\\hline
    Poldercast & Topic based & Decentralised & Ring based \acrshort{dht}/ Vicinity / Cyclon & Ring overlay per topic & Ring overlay routing & Yes & Yes (every publisher is a subscriber) & High resilience to churn, no subscription persistence \\\hline
    \end{tabular}
