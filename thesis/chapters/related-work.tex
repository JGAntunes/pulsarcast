...
calculating and removing the low-degree peers allows the system to build an
...
VCube-PS \cite{DeAraujo2017}. The clustering of subscribers still takes place,
however, dissemination trees rooted at each producer are dynamically built on a
per message basis.
