...
\ref{fig:graph-pulsarcast-event-percentage-fulfillment-comparison},
...
CPU usage was much lower in the second execution, between 3 and 4 vCPUs in the
...
\begin{figure}[!htb]
  \centering
  \includegraphics[width=0.4\textwidth]{img/graph-pulsarcast-latency-event-fulfillment-comparison.png}
...
For our second scenario, Pulsarcast with order guarantees, we obtained
